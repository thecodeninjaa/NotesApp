...
import { FiMail, FiLock, FiEye, FiEyeOff, FiArrowRight, FiZap, FiCheck } from 'react-icons/fi';
...
function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-100px] left-[-100px] w-[400px] h-[300px] bg-orange-500/5 blur-[100px] rounded-full pointer-events-none" />
          ...
          {success ? (
            ...
            <>
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-500 text-sm">Start organizing your thoughts in seconds</p>
              </div>
              ...
              <form onSubmit={handleSignup} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-sm font-medium text-gray-400" htmlFor="signup-email">
                    Email address
                  </label>
                ...
                {/* Password */}
                <div className="flex flex-col gap-1.5">
                  <label className="text-sm font-medium text-gray-400" htmlFor="signup-password">
                    Password
                  </label>
                  <div className="relative">
                  ...
                  <p className="text-xs text-gray-600 mt-0.5">Must be at least 6 characters</p>
                </div>
