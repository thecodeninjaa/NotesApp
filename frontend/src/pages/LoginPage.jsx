    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-white dark:bg-gray-800 flex-col justify-between p-12 border-r border-gray-100 dark:border-gray-700">
        ...
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-linear-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-md">
            <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
            </svg>
          </div>
          <span className="text-lg font-bold text-gray-800 dark:text-gray-200 tracking-wide">NoteFlow</span>
        </div>
        ...
        <p className="text-xs text-gray-300 dark:text-gray-600">© 2026 NoteFlow. All rights reserved.</p>
      </div>
